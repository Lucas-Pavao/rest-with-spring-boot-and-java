...
public class User implements UserDetails,Serializable {
    ...
    public void setAccountNonExpired(Boolean accountNonExpire) {
        this.accountNonExpired = accountNonExpire;
    }
    ...
    public void setCredentialsNonExpired(Boolean credentialsNonExpire) {
        this.credentialsNonExpired = credentialsNonExpire;
    }
